...
public class FreezeCameraKeyBind {
    ...
    public static void register() {
        freezeKey = KeyMappingHelper.registerKeyMapping(createCompatibleKeyBinding(
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            while (freezeKey.consumeClick()) {
                ...
                if (FreezeCameraClient.isFrozen() && client.player != null) {
                    ...
                    client.player.sendSystemMessage(Component.translatable("message.freezecamera.unfrozen"));
                }
            }
